          ...
          <div className="w-full max-w-sm bg-[#0B101E] border border-gold-border/40 rounded-2xl shadow-2xl overflow-hidden relative flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <div className="px-6 py-4 border-b border-glass-border flex items-center justify-between bg-white/[0.01]">
              ...
              <button 
                ...
                className="text-slate-400 hover:text-slate-100 text-xs font-semibold uppercase cursor-pointer"
              >
                Đóng
              </button>
            </div>
            ...
            <div className="p-6 space-y-5 overflow-y-auto max-h-[75vh]">
              ...
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <span className="text-[10px] text-slate-400 italic">Mã VietQR động tạo theo số tiền nạp</span>
              </div>
              ...
              <div className="space-y-3 bg-white/[0.02] border border-glass-border rounded-xl p-4 text-xs">
                <div className="flex justify-between py-1">
                  ...
                  <span className="text-slate-100 font-semibold">VietinBank</span>
                </div>
                <div className="flex justify-between py-1 border-t border-glass-border/40">
                  ...
                  <span className="text-slate-100 font-semibold flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="text-[10px] text-gold hover:text-slate-100 font-bold cursor-pointer"
                    >
                      (Sao chép)
                    </button>
                  </span>
                ...
                <div className="flex justify-between py-1 border-t border-glass-border/40">
                  ...
                  <span className="text-slate-100 font-semibold">DỰ ÁN EQUESTRIA</span>
                </div>
                <div className="flex justify-between py-1 border-t border-glass-border/40">
                  <span className="text-slate-400">Số tiền nạp:</span>
                  <span className="text-gold font-bold text-sm">
                    {(effectiveUsd * 25000).toLocaleString('vi-VN')} VND
                    <span className="text-[10px] font-normal text-slate-400 ml-1.5">(${effectiveUsd} USD)</span>
                  </span>
                </div>
                <div className="flex justify-between py-1 border-t border-glass-border/40">
            ...
            <div className="px-6 py-4 border-t border-glass-border flex items-center justify-end gap-3 bg-white/[0.01]">
              <button
                onClick={() => setShowVNPayModal(false)}
                className="px-4 py-2 border border-glass-border hover:bg-white/[0.04] text-slate-400 hover:text-slate-100 rounded-lg text-xs font-bold transition-all cursor-pointer"
              >
                Hủy giao dịch
              </button>
              <button
